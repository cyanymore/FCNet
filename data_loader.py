...
class DataSet(data.Dataset):
    ...
    def __init__(self, config, img_transform_gt, img_transform_sketch):
        ...
        if config['TRAINING_CONFIG']['TRAIN_DIR'] == 'anime':
            ...
            self.data_list = glob.glob(os.path.join(self.img_dir, '*.jpg'))
        elif config['TRAINING_CONFIG']['TRAIN_DIR'] == 'kaist':
            self.img_dir = '/home/cust/cust_data/cy/dataset/RefDayDataset/KAIST/trainB'
            self.skt_dir = '/home/cust/cust_data/cy/dataset/RefDayDataset/KAIST/trainA'
            self.data_list = glob.glob(os.path.join(self.img_dir, '*.jpg'))
